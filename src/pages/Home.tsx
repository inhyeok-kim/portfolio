                                        ...
                                        <Grid container marginTop={'50px'}>
                                            ...
                                            <Grid item xs={9}>
                                                <Grid container columnSpacing={4}>
                                                    ...
                                                    <Grid item xs={4}>
                                                        <Component imgSrc="/assets/images/component/paint.png" link="paint" title="Paint" />
                                                    </Grid>
                                                    <Grid item xs={4}>
                                                ...
                                                <Grid container columnSpacing={4} rowSpacing={4}>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Project 
                                                            ...
                                                            imgSrc={'/assets/images/project/editor/editor01.png'} direction="left" title="동시편집"  link="editor" />
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <Project 
                                                            content={(<>프로젝트 관리를 위한 종합 커뮤니케이션 어플리케이션</>)}
                                                            imgSrc={'/assets/images/project/pma/pma01.png'} disable={true} direction="right" title="PMA"  link="pma" />
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <Project 
                                                            content={(<>웹이지만 앱처럼. 모바일을 대상으로, PWA 기술을 적용시킨 가계부 앱</>)}
                                                            imgSrc={'/assets/images/project/acobook/acobook01.png'} disable={true}  direction="left" title="가계부"  link="acobook" />
                                                    </Grid>
                                                </Grid>
                                            </Grid>
